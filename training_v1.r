...
colums_to_be_dropped <- c("Age", "Gender", "Marital.Status..at.the.time.of.application.", "Income", "Education",
                          ...
                          "Marital.Status..at.the.time.of.application..binned")
...
logistic_3 <- glm(Performance_Tag ~ woe.Income.binned + woe.No.of.months.in.current.company.binned + 
...
logistic_4 <- glm(Performance_Tag ~ woe.Income.binned + woe.No.of.months.in.current.company.binned + 
...
logistic_5 <- glm(Performance_Tag ~ woe.Income.binned + woe.No.of.months.in.current.company.binned + 
                    woe.Profession.binned + woe.No_of_PL_trades_opnd_L12M.binned + 
                    woe.No_of_Inq_ex_HLAL_L12M.binned + woe.Avg_CC_Util_L12M.binned + 
...
logistic_6 <- glm(Performance_Tag ~ woe.Income.binned + woe.No.of.months.in.current.company.binned + 
...
logistic_7 <- glm(Performance_Tag ~ woe.Income.binned + woe.No.of.months.in.current.company.binned + 
                    woe.Profession.binned + 
                    woe.No_of_Inq_ex_HLAL_L12M.binned + woe.Avg_CC_Util_L12M.binned + 
                    woe.No_of_30dpd_L12M.binned, family = "binomial", data = train)
...
logistic_8 <- glm(Performance_Tag ~ woe.No.of.months.in.current.company.binned + 
                    woe.Profession.binned + 
                    woe.No_of_Inq_ex_HLAL_L12M.binned + woe.Avg_CC_Util_L12M.binned + 
                    woe.No_of_30dpd_L12M.binned, family = "binomial", data = train)
...
logistic_9 <- glm(Performance_Tag ~  
                    woe.Profession.binned + 
                    woe.No_of_Inq_ex_HLAL_L12M.binned + woe.Avg_CC_Util_L12M.binned + 
                    woe.No_of_30dpd_L12M.binned, family = "binomial", data = train)
...
predictions_logit <- predict(logistic_9, newdata = test)
