...
ready_data_set$Performance_Tag <- as.factor(ifelse(ready_data_set$Performance_Tag == 1, "yes", "no"))
...
logistic_3 <- glm(Performance_Tag ~ Income + ProfessionSE + No_of_60dpd_L6M + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_trades_opnd_L12M + No_of_PL_trades_opnd_L6M + 
                    ...
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)

vif(logistic_3)

summary(logistic_3)
#-----------------------------------------------------------
# removing No_of_trades_opnd_L12M 
logistic_4 <- glm(Performance_Tag ~ Income + ProfessionSE + No_of_60dpd_L6M + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_PL_trades_opnd_L6M + 
                    No_of_PL_trades_opnd_L12M + No_of_Inq_ex_HLAL_L6M + No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned + 
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)
...
logistic_5 <- glm(Performance_Tag ~ Income + ProfessionSE + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_PL_trades_opnd_L6M + 
                    No_of_PL_trades_opnd_L12M + No_of_Inq_ex_HLAL_L6M + No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned + 
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)
...
#-----------------------------------------------------------
# removing Income
logistic_6 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_PL_trades_opnd_L6M + 
                    No_of_PL_trades_opnd_L12M + No_of_Inq_ex_HLAL_L6M + No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned + 
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)
...
logistic_7 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_PL_trades_opnd_L6M + 
...
logistic_8 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                    No_of_90dpd_L12M + No_of_PL_trades_opnd_L6M + 
                    No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned + 
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)
...
logistic_9 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                    No_of_PL_trades_opnd_L6M + 
                    No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned + 
                    woe.Presence_of_opn_HL.binned, family = "binomial", data = train)
...
logistic_10 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                    No_of_PL_trades_opnd_L6M + 
                    No_of_Inq_ex_HLAL_L12M + 
                    Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned + woe.No_of_trades_opnd_L6M.binned, family = "binomial", data = train)
...
#-----------------------------------------------------------
# removing woe.No_of_trades_opnd_L6M.binned

logistic_11 <- glm(Performance_Tag ~ ProfessionSE + No_of_30dpd_L6M + 
                     No_of_PL_trades_opnd_L6M + 
                     No_of_Inq_ex_HLAL_L12M + 
                     Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned, family = "binomial", data = train)
...
logistic_12 <- glm(Performance_Tag ~ No_of_30dpd_L6M + 
                     No_of_PL_trades_opnd_L6M + 
                     No_of_Inq_ex_HLAL_L12M + 
                     Total_No_of_Trades + woe.Avg_CC_Util_L12M.binned, family = "binomial", data = train)
